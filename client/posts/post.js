...
const renderRelatedGallery = (records, currentSlug) => {
  ...
  const filteredPosts = records.filter(
...
const loadPostAndGallery = async () => {
  try {
    ...
    const targetEndpoint =
      currentSlug && currentSlug !== "posts.html" && currentSlug !== "posts"
        ? `https://periodic-thoughts-blog-server.onrender.com/api/articles/slug/${currentSlug}`
        : "https://periodic-thoughts-blog-server.onrender.com/api/articles/latest";
